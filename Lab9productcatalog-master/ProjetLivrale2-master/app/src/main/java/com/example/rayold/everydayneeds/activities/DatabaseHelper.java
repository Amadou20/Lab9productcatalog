...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Cursor getFournisseurService(){
        SQLiteDatabase db = this.getReadableDatabase();

        Cursor cursor = db.rawQuery("SELECT * FROM addServiceFournisseur",null);
        return cursor;
    }
    ...
    public Cursor getListContents(){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor data = db.rawQuery("SELECT * FROM addServiceFournisseur",null) ;
        return data ;
    }
